...
class CourseTestCase(TestCase):
    ...
    def test_course_name(self):
        ...
        course4 = Course.get_course(name="CPE 309")
        self.assertEqual(course1.name, "CPE 101")
        self.assertEqual(course2.name, "CPE 102")
        self.assertEqual(course3.name, "CPE 103")
        self.assertEqual(course4.name, "CPE 309")
